...
public class ProductView {
    ...
    public void showProduct(){
        ...
        System.out.format("                                          +---------+-----------------+-------------------+-------------------+----------------+%n");
        System.out.format("                                          |    ID   |     Danh mục    |    Tên sản phẩm   |    Giá sản phẩm   |   Trạng thái   |%n");
        System.out.format("                                          +---------+-----------------+-------------------+-------------------+----------------+%n");
        String leftAlignFormat = "                                          | %-7d | %-15s |  %-15s  |  %-15s  | %-6s |%n";
        for (Product listproduct:productList) {
            if (listproduct.getProductCatalog().isStatus()){
            System.out.format(leftAlignFormat,listproduct.getProductId(),listproduct.getProductCatalog().getName(),listproduct.getProductName(),Config.formatMoney.format(listproduct.getProductPrice()),(listproduct.getProductStatus()?"   Đang bán   ":"   Ngừng bán  "));
            }
        }
        System.out.format("                                          +---------+-----------------+-------------------+-------------------+----------------+%n");
    ...
    public void showProductAdmin(){
        System.out.println("                                                                     \u001B[33mDanh Sách Sản Phẩm KangNam Shop");
        System.out.format("                                     +---------+-----------------+-------------------+-------------------+----------------+----------+%n");
        System.out.format("                                     |    ID   |     Danh mục    |    Tên sản phẩm   |    Giá sản phẩm   |   Trạng thái   | Số lượng +%n");
        System.out.format("                                     +---------+-----------------+-------------------+-------------------+----------------+----------+%n");
        String leftAlignFormat = "                                     | %-7d | %-15s |  %-15s  |  %-15s  | %-6s | %-7d  |%n";
        for (Product listproduct:productList) {
            System.out.format(leftAlignFormat,listproduct.getProductId(),listproduct.getProductCatalog().getName(),listproduct.getProductName(),Config.formatMoney.format(listproduct.getProductPrice()),(listproduct.getProductStatus()?"   Còn hàng   ":" ( Hết hàng ) "), listproduct.getStock());
        }
        System.out.format("                                     +---------+-----------------+-------------------+-------------------+----------------+----------+%n");
    ...
    public void searchByName(){
        ...
        System.out.format("\u001B[33m                                          |    ID   |     Danh mục    |    Tên sản phẩm   |    Giá sản phẩm   |   Trạng thái   |%n\u001B[0m");
        System.out.format("\u001B[33m                                          +---------+-----------------+-------------------+-------------------+----------------+%n\u001B[0m");
        String leftAlignFormat = "\u001B[33m                                          | %-7d | %-15s |  %-15s  |  %-15s  | %-6s |%n\u001B[0m";
        for (Product p:productcontroller.searchByName(searchName)) {
            System.out.format(leftAlignFormat,p.getProductId(),p.getProductCatalog().getName(),p.getProductName(),Config.formatMoney.format(p.getProductPrice()),(p.getProductStatus()?"Đang hoạt động":"  ( Đang ẩn ) "));
        }
        System.out.format("\u001B[33m                                          +---------+-----------------+-------------------+-------------------+----------------+%n\u001B[0m");
    }
